...
export default function Accordins({ details }) {
    ...
    <div className={styles.infos__accordian}>
      ...
      >
        ...
        <AccordionDetails className="scrollbar">
          {details?.length > 0 && details?.slice(1, details?.length)?.map((info) => (
            <div className={styles.infos__accordian_grid} key={info?.name}>
              <span>{info?.name}:</span>
